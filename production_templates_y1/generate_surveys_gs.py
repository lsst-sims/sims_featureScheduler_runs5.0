...
def ddf_surveys(
    ...
    if obs_array is None:
        ...
        if save:
            np.savez(pre_comp_file, obs_array=obs_array.view(np.ndarray), hash_digest=hash_digest,
                     expt=expt, nexp=nexp, survey_start=survey_start, survey_length=survey_length,
                     science_program=science_program)
